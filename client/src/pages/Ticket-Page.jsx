...
//   const [loading, setLoading] = useState(false);
//   const [submitted, setSubmitted] = useState(false);
//   const [tickets, setTickets] = useState([]); // ✅ Fix: Define tickets state
...
//     try {
//       await axios.delete(`http://localhost:4000/user/deleteTicket/${ticketId}`);
//       setTickets(tickets.filter((ticket) => ticket._id !== ticketId)); // Remove deleted ticket
//     } catch (error) {
//       console.error("Error deleting ticket:", error);
//     }
//   };
